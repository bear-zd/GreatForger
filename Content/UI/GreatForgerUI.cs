...
namespace GreatForger.Content.UI
{
	...
	internal class GreatForgerUI : UIState
	{
		...
		public override void OnDeactivate()
		{
			...
			Main.LocalPlayer.QuickSpawnClonedItem(_vanillaItemSlot.entitySource, _vanillaItemSlot.Item);
		...
		public override void Update(GameTime gameTime)
		{
			...
			if (Main.LocalPlayer.talkNPC == -1 || Main.npc[Main.LocalPlayer.talkNPC].type != NPCType<NPCs.TheGreatForger>())
			{
				...
				GetInstance<GreatForger>().GreatForgerUserInterface.SetState(null);
			}
		}
		...
		protected override void DrawSelf(SpriteBatch spriteBatch)
		{
			...
			if (!tickPlayed)
			{
				Vector2 SoundPositiontemp = new Vector2(-1, -1);
				SoundEngine.PlaySound(SoundID.MenuTick, SoundPositiontemp);
			}
			...
			Vector2 SoundPosition = new Vector2(-1, -1);
			SoundEngine.PlaySound(SoundID.Item37, SoundPosition);
		}
	}
}
